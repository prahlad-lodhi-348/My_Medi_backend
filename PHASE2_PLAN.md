...
2. Create `src/constants/Config.ts` with `getBaseUrl()` (Android emulator `10.0.2.2` vs device `192.168.1.5`).
...
- Run `npx expo start`
- Test on Android emulator (10.0.2.2) and physical device (192.168.1.5)
